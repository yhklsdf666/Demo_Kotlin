...
import com.yhklsdf.demo_kotlin.activity.DetailActivity
...
class RVMainAdapter(val mList: MutableList<ItemLearnRv>, val type: String) : RecyclerView.Adapter<RVMainAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(itemEntity: ItemLearnRv) {
